...
public final class Data implements Cloneable {
  ...
  public java.util.List<java.lang.String> getWords() {
    ...
    try {
      proto.acquireLock();
      return sun7.DataModel.words(arg1);
    } finally {
      proto.releaseLock();
    }
  }
  ...
  private static class Html4JavaType extends org.netbeans.html.json.spi.Proto.Type<Data> {
    ...
    @Override public void call(Data model, int type, Object data, Object ev) throws Exception {
      switch (type) {
        case 0:
          sun7.DataModel.turnAnimationOn(model);
          return;
        case 1:
          sun7.DataModel.turnAnimationOff(model);
          return;
        case 2:
          sun7.DataModel.rotate5s(model);
          return;
        case 3:
          sun7.DataModel.showScreenSize(model);
          return;
      }
      throw new UnsupportedOperationException();
    }
